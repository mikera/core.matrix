...
(deftest test-comparison
  ...
  (testing "element-wise cmp"
    ...
    (is (= 0 (cmp 0 0)))
    (is (= 1 (cmp 1 -1)))
    (is (equals [[-1 0] [0 1]] (cmp [[1 3] [5 5]] [[3 3] [5 3]]))))
  (testing "element-wise lt"
    (is (= 1 (lt 1 4)))
    (is (= 0 (lt 3 3)))
    (is (equals [[1 0] [0 0]] (lt [[1 5] [3 6]] 3)))
    (is (equals [[1 0] [1 0]] (lt [[1 5] [4 6]] [[2 3] [5 6]]))))
  (testing "element-wise le"
    (is (= 1 (le 3 3)))
    (is (= 0 (le 4 3)))
    (is (equals [[1 0] [1 0]] (le [[1 5] [3 6]] 3)))
    (is (equals [[1 0] [1 1]] (le [[1 5] [4 6]] [[2 3] [5 6]]))))
  (testing "element-wise gt"
    (is (= 1 (gt 4 3)))
    (is (= 0 (gt 3 3)))
    (is (equals [[0 1] [0 1]] (gt [[1 5] [3 6]] 3)))
    (is (equals [[0 1] [0 0]] (gt [[1 5] [4 6]] [[2 3] [5 6]]))))
  (testing "element-wise ge"
    (is (= 0 (ge 2 3)))
    (is (= 1 (ge 3 3)))
    (is (equals [[0 1] [1 1]] (ge [[1 5] [3 6]] 3)))
    (is (equals [[0 1] [0 1]] (ge [[1 5] [4 6]] [[2 3] [5 6]]))))
  (testing "element-wise ne"
    (is (= 0 (ne 1 1)))
    (is (= 1 (ne 5 1)))
    (is (equals [[1 1] [0 1]] (ne [[1 5] [3 6]] 3)))
    (is (equals [[1 1] [1 0]] (ne [[1 5] [4 6]] [[2 3] [5 6]]))))
  (testing "element-wise eq"
    (is (= 1 (eq 1 1)))
    (is (= 0 (eq 5 1)))
    (is (equals [[0 0] [1 0]] (eq [[1 5] [3 6]] 3)))
    (is (equals [[0 0] [0 1]] (eq [[1 5] [4 6]] [[2 3] [5 6]])))))
